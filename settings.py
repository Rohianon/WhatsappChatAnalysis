...
TOOLTIPS = {
    ...
    'emoji-activity': 'Number of Activity (Emoji) for each weekday',
    'Week-day-activity': 'Number of Activity (message & event) for each hour',
    ...
    'active-times': 'Most Active times per day.',
